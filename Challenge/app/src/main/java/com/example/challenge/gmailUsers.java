...
public class gmailUsers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gmail_users);

        BaseDeDatos = new AdminSQLiteOpenHelper(this,"administracion", null,1);

        listItem = new ArrayList<>();

        userList = findViewById(R.id.idGmailList);

        viewData();
    }

    private void viewData(){
        Cursor cursor = BaseDeDatos.gmail();
